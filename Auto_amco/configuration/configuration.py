...
import logging
import os
from .locatorsLooker import locator
...
class Configuration:
    ...
    def inicia_pagina(self):
        ...
        #service = Service(service = Service(ChromeDriverManager().install())  )  # Asegúrate de definir el servicio aquí
        service = Service(executable_path = 'C:\\Auto_amco\\drivers\\chromedriver.exe')
